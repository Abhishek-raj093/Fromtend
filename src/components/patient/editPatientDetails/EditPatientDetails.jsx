...
const EditPatientDetails = () => {
    ...
    return (
        <div className='editpatientdetails'>
            <div className='editpatientimage'><img className='editpatientprofileimage' src={`https://nrebackend.onrender.com/` + patientDetails.profile_image} alt='patient'></img></div>
